...
{
  int number_of_training_samples = 4009;
  int attributes_per_sample = 2;
  int number_of_testing_samples = 2024;
  ...
  //cout << training_data->rows << " " << training_data->cols << endl;
  ...
  //read_data_from_csv(helper::string2char( "/home/jcacace/ros_ws/src/my/IIWA/iiwa_admittance_ctrl/ts/train_dirforce_normal" ), training_data, training_classifications, number_of_training_samples, attributes_per_sample);
    
  if (  read_data_from_csv(helper::string2char( "/home/jcacace/ros_ws/src/my/IIWA/iiwa_admittance_ctrl/ts/train_dirforce_normal" ), training_data, training_classifications, number_of_training_samples, attributes_per_sample) &&
        read_data_from_csv(helper::string2char( "/home/jcacace/ros_ws/src/my/IIWA/iiwa_admittance_ctrl/ts/test_dirforce_normal" ), testing_data, testing_classifications, number_of_testing_samples, attributes_per_sample))
  {
